...
namespace NaveXR.Device
{
    public abstract class Controller : MonoBehaviour
    {
        ...
        public void UpdateInputDeviceAndXRNode(XRNodeState nodeState, InputDevice inputDevice)
        {
            //更新位置
        ...
        protected abstract void OnUpdateInputDevice(ref InputDevice inputDevice);

        protected abstract void OnConnected(XRNodeState nodeState, InputDevice inputDevice);
