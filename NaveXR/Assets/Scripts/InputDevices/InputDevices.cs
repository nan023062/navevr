...
namespace Nave.VR
{
    ...
    public partial class InputDevices : MonoBehaviour
    {
        ...
        {
            UnityEngine.Debug.Log($"<b>{typeof(InputDevices).FullName}</b> : {log}");
        }

        public static void LogError(string log)
        {
            UnityEngine.Debug.LogError($"<b>{typeof(InputDevices).FullName}</b> : {log}");
        }
        ...
        private static InputDevices _instance;

        internal static InputDevices GetInstance() {
            CheckSingleton();
            return _instance;
        }
        ...
        {
            if(_instance == null) {
                var go = new GameObject($"[{typeof(InputDevices).FullName}]", typeof(InputDevices));
                GameObject.DontDestroyOnLoad(go);
                go.hideFlags = HideFlags.NotEditable;
                _instance = go.GetComponent<InputDevices>();
            }
        }
